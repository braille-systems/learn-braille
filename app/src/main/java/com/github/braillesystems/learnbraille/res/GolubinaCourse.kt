...
internal val golubinaIntroLessons by lessons {
    ...
    lesson(
        ...
        +Info("""Отметим, что правила написания букв и других символов соответствуют
                 <b>стандартам общеупотребительного Брайля</b>, принятым в России, которые утверждены Комиссией Центрального 
                 правления Всероссийского общества слепых в 2013 году.
                 Подробнее об этом можно прочесть на сайте комиссии:
                 <br>
                 <a href="http://www.chtenie.spb.ru/komissia.htm">www.chtenie.spb.ru/komissia.htm</a>
           """
        )
        +Info(InfoInterpolation.run {
