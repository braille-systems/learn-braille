...
internal val golubinaIntroLessons by lessons {
    ...
    lesson("Специальные символы") { // Golubina: pp 59-62
        ...
        +Info(
            """
                    Знак ударения обозначается точкой 4 и ставится в клетке перед ударной гласной. 
                    <br>
                    Например, в слове МОСКВА знак ударения будет стоять перед буквой А.
                    """
        )
        showAndInputChars("\'")
        +Info(
        ...
        +Info(
            """
                    ...
                    или кавычки.
                    <br>
                    Знак курсивного шрифта обозначается точками 4, 5, 6 (совпадает с признаком большой
                    латинской буквы).
                    <br>
                    Знак жирного шрифта - точки 1, 2, 4, 5, 6 (то есть все, кроме третьей).
                    """
        )
