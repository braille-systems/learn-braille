...
internal val golubinaIntroLessons by lessons {
    ...
    lesson("Ноты"){
        ...
        +Info(
            """
               Ноты длительности <b>одна четверть</b> образуются путём добавления точки 6.
               <br>
               Длительности <b>одна вторая</b> -- путём добавления точки 5.
               <br>
               <b>Целая нота</b> -- путём добавления точек 5 и 6 вместе.
            """
        )
        +Info(InfoInterpolation.run {
            """
