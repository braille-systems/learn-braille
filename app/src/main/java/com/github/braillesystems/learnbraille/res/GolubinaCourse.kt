...
internal val golubinaIntroLessons by lessons {
    ...
    lesson(
        ...
        +InputDots(text = "Введите точку три", dots = BrailleDots(E, E, E, F, E, E))
        +ShowDots(
            text = "Перед Вами символ шрифта Брайля - <br>" +
                    " точка номер пять",
        ...
        +InputDots(text = "Введите точку пять", dots = BrailleDots(E, E, E, E, E, F))
        +InputDots(
    ...
    lesson(
        ...
        +Info(InfoInterpolation.run {
            """
                ...
                <br>
                Теперь Вам знаком весь русский алфавит и цифры. Следующие уроки покрывают
                полезный материал, который встречается в брайлевских книгах не так часто, поэтому
                упражнений будет меньше и материал будет, скорее, справочный.
            """
        })
    }
