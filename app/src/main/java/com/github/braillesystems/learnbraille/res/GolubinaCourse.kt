...
internal val golubinaIntroLessons by lessons {
    ...
    lesson(
        ...
        +Info(
            """
                В шаге с демонстрацией столбец с точками 1, 2, 3 находится слева,
                а в шаге с вводом - справа, потому что буквы пишутся на обороте листа, а для чтения 
                лист переворачивается.
                <br>
                Впрочем, порядок столбцов в этом приложении можно изменить кнопкой <b>"Режим письмо/чтение"</b>
                справа на экране над кнопкой <b>"Вперёд"</b>.
                <br>
                В настройках можно отключить "При вводе столбец с точками 1, 2, 3 справа". Тогда
                при заходе в любой шаг точки 1, 2, 3 будут слева, но это по-прежнему можно будет изменить,
                нажав кнопку <b>"Режим письмо/чтение"</b>.
                """
        )
        +ShowDots(
            text = "Перед Вами символ шрифта Брайля - <br>" +
    ...
    lesson("Греческий алфавит") {
        ...
        +Info("""
            Изученное нами соответствие греческих букв шеститочиям - лишь один из возможных вариантов,
            принятый в советской и российской математической нотации.
            Распространены также два других стандарта: международный и греческий литературный,
            которые отличаются в нескольких символах и не изучаются в нашем кратком курсе.
        """)
